import math
from .dron_controls import obtener_coordenadas, rotar_dron, obtener_datos_telemetria
...
def crear_mision(waypoints):
   ...
   try:
       telemetry = obtener_datos_telemetria()
       if telemetry["estado"] != "success":
           raise ValueError("No se pudo obtener la telemetría del dron")
           
       current_heading = telemetry["data"]["direccion"]
       current_lat = telemetry["data"]["lat"]
       current_lon = telemetry["data"]["lon"]
